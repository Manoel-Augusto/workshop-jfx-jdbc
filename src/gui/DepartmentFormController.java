...
public class DepartmentFormController implements Initializable {
	...
	@FXML
	public void onBtSaveAcrion(ActionEvent event) {
	...
	private Department getFormData() {
		...
		ValidationException exception = new ValidationException(txtId.getText());
	...
	@FXML
	public void onBtCancelAcrion(ActionEvent event) {
		Utils.currentStage(event).close();
	}
